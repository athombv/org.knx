...
module.exports = machina.Fsm.extend({
    ...
    connecting: {
      _onEnter: function( ) {
        ...
        if (this.useTunneling) {
          ...
          // if (!this.localAddress) throw "Not bound to an IPv4 non-loopback interface"; // Removed, let the OS handle the path to the endpoint
  ...
  getLocalAddress: function() {
    ...
    console.log('Interfaces in FSM', candidateInterfaces);
