...
class GenericKNXDevice extends Homey.Device {
  ...
  addKNXEventListeners(settings) {
    ...
    // Address guard required: ga_temperature_min/max are optional settings (may be empty string)
    if (this.hasCapability('target_temperature_min') && settings.ga_temperature_min) {
      this.knxInterface.addKNXEventListener(settings.ga_temperature_min, this.KNXEventHandler);
    }
    if (this.hasCapability('target_temperature_max') && settings.ga_temperature_max) {
      this.knxInterface.addKNXEventListener(settings.ga_temperature_max, this.KNXEventHandler);
    }
  ...
  removeKNXEventListeners(settings) {
    ...
    // Address guard required: ga_temperature_min/max are optional settings (may be empty string)
    if (this.hasCapability('target_temperature_min') && settings.ga_temperature_min) {
      this.knxInterface.removeKNXEventListener(settings.ga_temperature_min, this.KNXEventHandler);
    }
    if (this.hasCapability('target_temperature_max') && settings.ga_temperature_max) {
      this.knxInterface.removeKNXEventListener(settings.ga_temperature_max, this.KNXEventHandler);
    }
    if (this.hasCapability('windowcoverings_set')) {
