...
class GenericKNXDevice extends Homey.Device {
  ...
  addKNXEventListeners(settings) {
    ...
    if (this.hasCapability('actuator_value')) {
      this.knxInterface.addKNXEventListener(settings.ga_actuator_value,
        this.KNXEventHandler);
    }
  ...
  removeKNXEventListeners(settings) {
    ...
    if (this.hasCapability('actuator_value')) {
      this.knxInterface.removeKNXEventListener(settings.ga_actuator_value, this.KNXEventHandler);
    }
  }
