...
class GenericKNXDevice extends Homey.Device {
  ...
  addKNXEventListeners(settings) {
    ...
    if (this.hasCapability('hvac_operating_mode')) {
      this.knxInterface.addKNXEventListener(settings.ga_hvac_operating_mode,
        this.KNXEventHandler);
    }
    if (this.hasCapability('heating_variable_correction')) {
      this.knxInterface.addKNXEventListener(settings.ga_heating_variable_correction,
        this.KNXEventHandler);
    }
  ...
  removeKNXEventListeners(settings) {
    ...
    if (this.hasCapability('hvac_operating_mode')) {
      this.knxInterface.removeKNXEventListener(settings.ga_hvac_operating_mode, this.KNXEventHandler);
    }
    if (this.hasCapability('heating_variable_correction')) {
      this.knxInterface.removeKNXEventListener(settings.ga_heating_variable_correction, this.KNXEventHandler);
    }
  }
