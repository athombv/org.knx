...
class KNXGenericDriver extends Homey.Driver {
    ...
    getGroupAddressList() {
        ...
        if(this.selectedInterfaceMAC) {
            ...
            console.error('A IP interface MAC should be selected first!');
    ...
    onPair(socket) {
        ...
        socket.on('search_interfaces', (callback) => {
            Homey.app.searchInterfaces()
            // needs to be checked with real KNX ip interfaces!
