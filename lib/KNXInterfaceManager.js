      ...
      this.findKNXInterfaces()
        .catch((error) => {
          ...
          for (const interface of interfaces) {
            ...
            if (interface && interface.mac && interface.ip && !this.KNXInterfaces[interface.mac]) {
              try {
                await this.discoverKNXInterfaceOnIP(interface.ip);
              } catch (error) {
                this.errorLog('Error checking interface', interface.ip, error);
              }
            }
          }
        });
