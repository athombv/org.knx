...
const FIND_DEVICES_INTERVAL = 3 * (60 * 1000); // 3 minute search loop
      ...
      this.findKNXInterfaces()
        .catch(error => {
          ...
          for (const i of interfaces) {
            ...
            if (i && i.macAddress && i.ipAddress && !this.KNXInterfaces[i.macAddress]) {
              this.checkKNXInterface(i.ipAddress);
            }
          }
        });
    } else {
        ...
        udpSocket
          ...
          .on('message', (msg, rinfo) => {
            ...
            try {
              ...
              const interfaces = Object.values(this.KNXInterfaces).map(i => {return {macAddress: i.macAddress, ipAddress: i.ipAddress, name: i.name, knxAddress: i.knxAddress}});
