...
class KNXInterface extends EventEmitter {
	constructor(knxInterface) {
		...
		this.reconnectKNX = this._reconnectKNX.bind(this); // binding the reconnect function to the correct context
	...
	_reconnectKNX() {
		...
		// Gooi een error naar de gebruiker dat de verbinding tijdelijk niet beschikbaar is
	}

	// KNX connection eventlistener, triggered when an KNX connection is established
